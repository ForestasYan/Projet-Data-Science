...
def Recuperer_plays(joueur):
    
    html = urlopen("https://osustats.click/" + joueur)
    ...
    craftcans.columns = ["id", "score_id", "beatmap_id", "nb_100", "nb_300", "nb_50", "miss", "date", "mods", "maxcombo", "pp", "rank", "score"]
