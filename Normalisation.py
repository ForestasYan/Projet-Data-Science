...
def creer_apuis(lignes_types, nb_colonnes):
    ...
    for ligne in lignes_types:
        if ligne[0] == 'courte':
            ...
            appuis.append([int(0.1 + (val_col - 512/(2*nb_colonnes))/(512/nb_colonnes)), val_debut, val_debut+30])
            ...
            appuis.append([int(0.1 + (val_col - 512/(2*nb_colonnes))/(512/nb_colonnes)), val_debut, val_fin])     
    return appuis
